...
async function fetchBranding() {
  try {
    ...
    return { siteName: d?.siteName || 'PteroDash', siteIcon: d?.siteIcon || '', emailVerification: d?.emailVerification || false };
  } catch {
    return { siteName: 'PteroDash', siteIcon: '', emailVerification: false };
  }
}
