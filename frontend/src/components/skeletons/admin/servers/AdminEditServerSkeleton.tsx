...
export default function AdminEditServerSkeleton() {
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="rounded-2xl p-6 space-y-4" style={{ border: '1px solid var(--border)', background: 'var(--surface)' }}>
        <div className="h-5 w-36 bg-[#202020] rounded animate-pulse" />
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-2">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="space-y-2">
              <div className="h-3 w-24 bg-[#202020] rounded animate-pulse" />
              <div className="h-4 w-40 bg-[#202020] rounded animate-pulse" />
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="rounded-2xl p-6" style={{ border: '1px solid var(--border)', background: 'var(--surface)' }}>
        <div className="h-5 w-36 bg-[#202020] rounded animate-pulse mb-6" />
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="space-y-2">
              ...
              <div className="h-3 w-44 bg-[#202020] rounded animate-pulse" />
            </div>
          ))}
        </div>
      </div>
