  ...
  return (
    <div className="p-4 sm:p-6 bg-[#0F0F0F] min-h-screen">
      <div className="flex flex-col h-full space-y-6">
        ...
        {/* Page header — matches <header> in real page */}
        <header>
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          {/* Left Nav (Statuses) — matches AdminTicketNavSidebar */}
          <aside className="w-full lg:w-48 shrink-0 pt-1">
            <div className="sticky top-6 flex flex-col gap-6">
              ...
              <div>
                ...
                <nav className="space-y-0.5 pr-1">
                  {[
                    ...
                    <div
                      key={idx}
                      className={`group relative flex w-full items-center gap-3 rounded-lg py-2 px-2.5 ${idx === 0 ? 'bg-white/10' : ''}`}
                    >
                      <div className="h-4 w-4 shrink-0 rounded bg-[#202020] animate-pulse" />
                      <div className={`h-3.5 flex-1 ${item.w} rounded bg-[#202020] animate-pulse`} />
                      <div className={`ml-auto h-3 ${item.count} rounded bg-[#1A1A1A] animate-pulse font-mono`} />
                    </div>
                  ))}
                </nav>
              </div>
              ...
              <div>
                ...
                <nav className="space-y-0.5 pr-1">
                  <div className="group relative flex w-full items-center gap-3 rounded-lg py-2 px-2.5">
                    <div className="h-4 w-4 shrink-0 rounded bg-[#202020] animate-pulse" />
          ...
          {/* Content Area — matches real page */}
          <div className="flex-1 min-w-0 w-full">
            ...
            {/* Table area — matches <div className="border-0 p-0"> wrapper */}
