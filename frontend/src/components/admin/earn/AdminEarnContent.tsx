      ...
      <div className="w-full">
        ...
        <div className="divide-y divide-[#222]">
          <EarnMethodRow
            ...
            rewardStr={`${form.ads.coins} coins`}
            limitStr={`${form.ads.maxClaimsPerDay} claims`}
          ...
          <EarnMethodRow
            ...
            rewardStr={`${form.linkvertise.coins} coins`}
            limitStr={`${form.linkvertise.maxClaimsPerDay} claims`}
            enabled={form.linkvertise.enabled}
            cols={cols}
