...
export function AdminServerSort({ sortBy, setSortBy }: AdminServerSortProps) {
  ...
  return (
    <div className="relative" ref={sortRef}>
      ...
      {sortOpen && (
        <div className="absolute z-50 top-[calc(100%+8px)] right-0 w-[200px] border border-[#222] rounded-md bg-[#151515] p-2 shadow-xl">
          <div className="px-2 pb-2 pt-1">
            <span className="text-[#666] text-[8px] font-semibold uppercase tracking-[0.7px]">Sort Servers</span>
          </div>
