...
export default function NewEggHeader() {
  return (
    <div className="flex items-center gap-3 mb-8">
      ...
      <div>
        <h1 className="text-2xl sm:text-3xl font-extrabold">New Egg</h1>
        <p className="text-[#AAAAAA] text-base sm:text-lg">Define template and behavior</p>
      </div>
    </div>
  );
}
