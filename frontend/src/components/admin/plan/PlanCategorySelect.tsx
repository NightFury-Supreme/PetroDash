...
export function PlanCategorySelect({
  ...
  const loadCategories = () => {
    ...
    fetchWithRetry(`${process.env.NEXT_PUBLIC_API_BASE || ''}/api/admin/plans/categories`, { 
              ...
              {categories.map(c => (
                ...
                >
                  <div className="flex items-center gap-2 overflow-hidden">
                    ...
                    <span className="text-xs px-1.5 py-0.5 rounded-md bg-white/[0.04] text-[#888]">{c.planCount} plans</span>
                  </div>
