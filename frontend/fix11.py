...
# The div starts with <div> then <label ...>Flag / Icon</label>
# and ends right before <div><label ...>Node IP</label>

old_ui_pattern = r'<div>\s*<label[^>]*>Flag / Icon</label>.*?</div>\s*<div>\s*<label[^>]*>Node IP</label>'

new_ui = """<div>
                  <label className="block text-xs font-medium text-[#D4D4D4] mb-1.5">Flag / Icon</label>
