...
# ----------------- REGISTER -----------------
write_file('frontend/src/components/auth/register/RegisterForm.tsx', """'use client';
  ...
  return (
    <div className="w-full">
      <div className="text-left mb-8">
        <h2 className="text-2xl font-bold mb-1.5 tracking-tight">Create an Account</h2>
        <p className="text-[13px] text-[#888888]">Sign up to get started</p>
      </div>
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        {showEmailRegister && (
          <div className="text-[12px] text-[#888888] text-left mt-6">
            Already have an account? <Link href="/login" className="text-[#FF5722] hover:text-[#F4511E] transition-colors font-medium">Login</Link>
          </div>
        )}
      </form>
    </div>
