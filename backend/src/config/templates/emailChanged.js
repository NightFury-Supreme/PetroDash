module.exports = {
  "subject": "Notice: Your {{siteName}} email has been changed",
  "html": `
      ...
      <div style="width: 100%; max-width: 800px; margin: 0 auto; overflow: hidden; border: 1px solid #292929; border-radius: 9px; background-color: #101010; color: #eeeeee;">
        ...
        <div style="padding: 64px 72px 60px;">
          ...
          <p style="margin: 18px 0 0; color: #999999; font-size: 18px; line-height: 1.7;">
            The email address associated with your {{siteName}} account was recently changed to <strong>{{newEmail}}</strong>.
          </p>
          ...
          <div style="margin-top: 48px; padding: 24px 28px; border-left: 5px solid #ff5a1f; background-color: #1a120e; color: #958077; font-size: 15px; line-height: 1.7;">
            ...
            If you changed your email address, you can safely ignore this email. If you did not make this change, please contact support immediately to secure your account.
          </div>
        </div>
  ...
  `,
  "text": "The email address associated with your {{siteName}} account was recently changed to {{newEmail}}. If you did not make this change, please contact support immediately."
};
