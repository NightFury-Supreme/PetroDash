module.exports = {
  ...
  "html": `
    <div style="width: 100%; min-height: 100vh; padding: 40px 16px; box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif;">
      <div style="width: 100%; max-width: 800px; margin: 0 auto; overflow: hidden; border: 1px solid #292929; border-radius: 9px; background-color: #101010; color: #eeeeee;">
        ...
        <div style="width: 100%; height: 3px; background-color: #ef4444;"></div>

        <div style="padding: 64px 72px 60px;">
          <div style="margin-bottom: 16px; color: #ef4444; font-size: 13px; font-weight: 700; letter-spacing: 1.6px; line-height: 1.4; text-transform: uppercase;">
            SECURITY ALERT
          </div>
          ...
          <p style="margin: 18px 0 0; color: #999999; font-size: 18px; line-height: 1.7;">
            Two-factor authentication (2FA) has been disabled on your {{siteName}} account. Your account is now less secure and only requires a password to log in.
          </p>
          ...
          <div style="margin-top: 48px; padding: 24px 28px; border-left: 5px solid #ff5a1f; background-color: #1a120e; color: #958077; font-size: 15px; line-height: 1.7;">
            ...
            If you disabled 2FA, you can safely ignore this email. If you did not make this change, please contact support immediately to secure your account.
          </div>
        </div>
  ...
  `,
  "text": "Two-factor authentication has been disabled for your {{siteName}} account. If you did not do this, please contact support immediately."
};
