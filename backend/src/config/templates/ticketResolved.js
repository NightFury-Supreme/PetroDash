module.exports = {
      ...
      <div style="width: 100%; max-width: 800px; margin: 0 auto; overflow: hidden; border: 1px solid #292929; border-radius: 9px; background-color: #101010; color: #eeeeee;">
        ...
        <div style="padding: 64px 72px 60px;">
          ...
          <p style="margin: 18px 0 0; color: #999999; font-size: 18px; line-height: 1.7;">
            We're glad to let you know that your support ticket "<strong>{{title}}</strong>" has been successfully resolved!
          </p>
              ...
              <div style="display: table-cell; padding: 24px; width: 50%; vertical-align: top;">
                <div style="margin-bottom: 24px;">
                  ...
                  <div style="color: #eeeeee; font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace; font-size: 15px;">
                    <span style="display: inline-block; padding: 2px 10px; border-radius: 9999px; background-color: #18253a; color: #93c5fd; border: 1px solid #1a396b; font-size: 11px; font-weight: 600; text-transform: uppercase;">Resolved</span>
                  </div>
                </div>
                <div>
          ...
          <div style="margin-top: 48px; padding: 24px 28px; border-left: 5px solid #3b82f6; background-color: #0f172a; color: #93c5fd; font-size: 15px; line-height: 1.7;">
            <div style="margin-bottom: 8px; color: #bfdbfe; font-size: 15px; font-weight: 600;">
              Need more help?
            </div>
            If you're still experiencing issues, you can reopen this ticket from your dashboard or create a new one at any time.
          </div>
  ...
  `,
  "text": "Your ticket \"{{title}}\" has been resolved."
};
